...
class _UpdatePageState extends State<UpdatePage> {
  ...
  void _update(BuildContext context)async{
    if(titleController.text.isNotEmpty && deskripsiController.text.isNotEmpty && statusController.text.isNotEmpty && gambar != null){
      ...
      await databaseHelper.updateTask(updateTask, widget.task.id!);
      AwesomeDialog(
        context: context,
        animType: AnimType.scale,
        dialogType: DialogType.success,
        title: 'Success',
        desc: 'Berhasil mengupdate Tugas',
        btnOkOnPress: (){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Update Tugas ${widget.task.title}"),
      ),
